...
function preload()
{
  ...
  imgturban = loadImage("https://i.ibb.co/RgLfT39/MAHARASHTRA-0.png");
}
...
function drawturban()
{
  ...
  {
    push();
    const wx = Math.abs(positions[13][0] - positions[1][0]) * 1.9; // The width is given by the face width, based on the geometry
